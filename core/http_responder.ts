...
import {HttpContainerInterface, HttpResponderInterface} from "./interfaces/http";

export class HttpResponder implements HttpResponderInterface {

    constructor(readonly http: HttpContainerInterface, readonly engine: EngineInterface) {
    }
