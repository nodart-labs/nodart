...
export interface BaseHttpResponseInterface
  extends HttpDataInterface,
...
export interface HttpContainerInterface extends BaseHttpResponseInterface {
  ...
  fetchData(
    onSuccess: (data: JSONLikeInterface) => any,
...
export interface HttpFormDataClientConfigInterface
  extends HttpFormDataConfigInterface {
