...
export type AppModules = {
  types?: Array<[type: typeof AppModule, config?: AppModuleConfigInterface]>;
  modules?: {
    [name: string]: [type: typeof AppModule, config?: AppModuleConfigInterface];
  };
};

export type AppEmitterFacade<K extends keyof AppEmitterEvents> = (
