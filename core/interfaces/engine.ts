export interface EngineInterface {
  ...
  getTemplate(template: string, assign?: object, ...args): string;
}
...
export interface EngineClientConfigInterface extends EngineConfigInterface {
...
export type EngineOptions = {
  ...
  tags?: {
    // (default: see nunjucks syntax) defines the syntax for nunjucks tags. See Customizing Syntax
    blockStart?: string;
    blockEnd?: string;
