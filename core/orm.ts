...
export abstract class OrmMigrationSource {
    ...
    readonly abstract migrations: OrmMigrationInterface
    ...
    get migrationList() {
        ...
        return this._migrationList.length === 0 ? Object.keys(this.migrations ?? {}) : this._migrationList
    }
...
export class OrmMigrator {
     ...
     * @param args
     */
    source(src: OrmMigrationSource | typeof OrmMigrationSource | string, ...args: any) {
...
export abstract class OrmSeedSource {
    ...
    readonly abstract seeds: OrmSeedInterface

    protected constructor(protected _seedsList: string[] = []) {
    }

    get seedList() {
        return this._seedsList.length === 0 ? Object.keys(this.seeds ?? {}) : this._seedsList
    }
